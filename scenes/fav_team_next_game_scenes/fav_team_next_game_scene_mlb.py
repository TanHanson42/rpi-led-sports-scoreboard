...
class MLBFavTeamNextGameScene(FavTeamNextGameScene):
    """ Favourite team next game scene for the MLB. Contains functionality to pull schedule data from the MLB Stats API, parse, and build+display images based on the result.

...
class CFBFavTeamNextGameScene(FavTeamNextGameScene):
    """ Favourite team next game scene for CFB. Contains functionality to pull schedule data from ESPN API, parse, and build+display images based on the result.
    ...
    def display_scene(self):
        ...
        if self.favourite_teams:
            for team in self.favourite_teams:
                next_game_details = data.cfb_data.get_next_game(team)

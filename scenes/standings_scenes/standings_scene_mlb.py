...
class MLBStandingsScene(StandingsScene):
    """ Standings scene for the MLB. Contains functionality to pull standings data from the MLB Stats API, process as needed, and build+display images based on the result.
    ...
    def display_scene(self):
        ...
        for type in self.settings['display_for']:
            ...
            # Leagues (AL and NL).
                ...
                for league in self.data['standings']['league']['leagues'].items():
                    league_details = league[1]

...
class CFBStandingsScene(StandingsScene):
    """ Standings scene for CFB. Contains functionality to pull standings data from the ESPN API, process as needed, and build+display images based on the result.
    ...
    def display_scene(self):
        ...
        self.data = {
            'standings': data.cfb_data.get_standings()
        }
        ...
        for type in self.settings['display_for']:
            # Conferences (only standing type available for CFB).
            if type == 'conference':

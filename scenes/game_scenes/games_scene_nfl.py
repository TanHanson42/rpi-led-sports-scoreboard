...
class NFLGamesScene(GamesScene):
    """ Game scene for the NFL. Contains functionality to pull data from ESPN API, parse, and build+display specific images based on the result.
    ...
    def display_scene(self):
        ...
        self.data = {
            ...
            'games': data.nfl_data.get_games(dates_to_display[-1]),
        }
    ...
    def add_playing_period_to_image(self, game):
        ...
        # 2OT or later (NFL playoff rules allow multiple OTs).
        elif game['period_num'] > 5:
